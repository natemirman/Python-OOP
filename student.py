...
def main():
    ...
    student_list = [
        Student(names_list[0], birthyear_list[0], student_id_list[0], credit_hours_list[0]),
        Student(names_list[1], birthyear_list[1], student_id_list[1], credit_hours_list[1]),
        Student(names_list[2], birthyear_list[2], student_id_list[2], credit_hours_list[2]),
        Student(names_list[3], birthyear_list[3], student_id_list[3], credit_hours_list[3]),
    ]
